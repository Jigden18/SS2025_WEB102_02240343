...
export declare const verify: (token: string, publicKey: import("hono/utils/jwt/jws").SignatureKey, alg?: "HS256" | "HS384" | "HS512" | "RS256" | "RS384" | "RS512" | "PS256" | "PS384" | "PS512" | "ES256" | "ES384" | "ES512" | "EdDSA") => Promise<import("hono/utils/jwt/types").JWTPayload>;
export declare const decode: (token: string) => {
    header: import("hono/utils/jwt/jwt").TokenHeader;
    payload: import("hono/utils/jwt/types").JWTPayload;
};
export declare const sign: (payload: import("hono/utils/jwt/types").JWTPayload, privateKey: import("hono/utils/jwt/jws").SignatureKey, alg?: "HS256" | "HS384" | "HS512" | "RS256" | "RS384" | "RS512" | "PS256" | "PS384" | "PS512" | "ES256" | "ES384" | "ES512" | "EdDSA") => Promise<string>;
